...
void check_boolean(ifcgeom::Nef_polyhedron const& p, unsigned i) {
  REQUIRE(!p.is_empty());
...
TEST_CASE("Boolean Test") {
  ...
  ifcgeom::Nef_polyhedron nef_polyhedron{polyhedron};
  ...
  auto nef_poly_2 = ifcgeom::Nef_polyhedron{nef_polyhedron};
  ...
  SUBCASE("UNION") {
    ifcgeom::Nef_polyhedron boolean_union{nef_polyhedron + nef_poly_2};
    check_boolean(boolean_union, 46);
  }
  SUBCASE("DIFFERENCE") {
    ifcgeom::Nef_polyhedron boolean_difference{nef_polyhedron - nef_poly_2};
    check_boolean(boolean_difference, 19);
  }
  SUBCASE("INTERSECTION") {
    ifcgeom::Nef_polyhedron boolean_intersection{nef_polyhedron * nef_poly_2};
